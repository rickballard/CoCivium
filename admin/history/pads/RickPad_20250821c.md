...
**Files to add (later).** [docs/policies/STEPBACK.md](docs/policies/STEPBACK.md), `TRANSITION-NOTICE.md`, `CONSULTING.md`, `GOVERNANCE.md` (v2), `CODEOWNERS`, `SECURITY.md`, `.github/ISSUE_TEMPLATE/fst-activation.md`.
