...
- [ ] **Vision page polish** ([docs/vision/CoCivium_Vision.md](docs/vision/CoCivium_Vision.md)): add 1-page overview (“Why now / How it works / What’s different”) + embed a simple flow diagram.
- [ ] **Consenti landing polish** (`scroll/Cognocarta_Consenti.md`): add mermaid decision diagram + “Adopt this charter” snippet.
- [ ] **Create [docs/sources/](docs/sources/)** with `annotated-bibliography.md` (seed 10 credible references) and `comparable-initiatives.md`.
...
- [ ] **Open Collective setup** (see [docs/funding/OPEN_COLLECTIVE.md](docs/funding/OPEN_COLLECTIVE.md)): choose fiscal host, create **cocivium**, test $1 donation.
...
- [ ] **Translations** scaffolding (start with i18n plan in [docs/i18n/](docs/i18n/)).
...
- [ ] [docs/sources/annotated-bibliography.md](docs/sources/annotated-bibliography.md)  -  10+ references (governance, co-ops, DAOs, civic tech, public admin) with 1–2 line annotations.
- [ ] [docs/sources/comparable-initiatives.md](docs/sources/comparable-initiatives.md)  -  adjacent projects; lessons to copy (not marketing).
...
## Engineering & CI
- [ ] `markdownlint` + `codespell` Actions; custom dictionary in [docs/lexicon/](docs/lexicon/).
...
- [ ] Keep **Gift Policy** linked from README → [docs/FUNDING.md](docs/FUNDING.md).
