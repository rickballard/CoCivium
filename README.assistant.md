...
## Fast Paths
- **Constitution (CC)  -  polish first: [docs/cc/](docs/cc/)
- **Onramps:** [docs/onramps/](docs/onramps/)
- **BPOE / Playbooks:** [docs/BPOE/](docs/BPOE/)
- **Domains:** `domains/`
- **Projects:** `modules/` or `projects/`
- **Insights (incl. poetry):** `insights/`
- **Idea Cards:** `ideas/`
- **Assets / Brand:** `assets/` and [docs/brand/](docs/brand/)
