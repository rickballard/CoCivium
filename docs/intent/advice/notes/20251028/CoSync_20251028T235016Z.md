...
- Linked gallery from [docs/DIAGRAMS.md](docs/DIAGRAMS.md).
...
4. As new diagrams land, keep meta in [docs/diagrams/meta/](docs/diagrams/meta/) updated; the Inventory will surface captions/tags.
