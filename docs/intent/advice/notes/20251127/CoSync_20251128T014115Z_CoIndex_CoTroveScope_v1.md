# CoSync note - CoIndex CoTrove scope-drop (advisory)

Timestamp: 20251128T014115Z  
Repo: CoCivium  
...
- The memo arrived via a Downloads path and must be adopted via normal CoIndex PR flow.

## Location

- CoIndex file (proposed canonical path once committed):
  - CoIndex/docs/CoIndex_ScopeDrop_CoTroveAndMining_v1.md
...
- The CoTrove scope memo explicitly states:
  - It is advice only.
  - It was initially off-repo in Downloads.
  - CoIndex should decide what to keep, change, or discard.
